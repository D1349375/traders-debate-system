...
### 🛑 目前狀態：新人格暫不納入生效（2026-07-20 使用者裁示）

**Rekt Capital、Benjamin Cowen、Michaël van de Poppe 三位已蒸餾完成，但先不上線。**

- **不要**在 [preregistration.md](preregistration.md) 增補 §8 登記
- **不要**把新人格加進每日 bias 流程
- `.claude/skills/` 下的新人格資料夾**是已完成的資產，不是待上線的組態**

下面的啟用流程是**給未來決定上線時用的**，在使用者另行裁示前請不要執行。
單獨測試某個人格（對話中問它、給它看一張圖）不影響統計，可以做。

詳見 [HANDOFF.md](HANDOFF.md)。

---

**未來上線時必須做的事**：預登記已於 2026-07-19 生效。**納入新人格屬於受測系統的重大變更**，必須先在 [preregistration.md](preregistration.md) 以 §8 增補條目登記（載明人格清單與各自語料截止日），之後多人格紀錄才可以落地。多人格一旦生效，R2 結構化反駁自動啟用（協議與 DB 皆已支援）。
